                    ...
                    <div className="order-2 md:order-2 md:col-span-8 lg:col-span-8 relative w-full h-[380px] sm:h-[480px] md:h-[85vh] flex items-end justify-center">
                        ...
                        >
                            <Image
                                ...
                                height={900}
                                priority
                                className=" w-full h-auto max-h-[58vh] lg:max-h-[65vh] object-contain drop-shadow-[0_15px_45px_rgba(6,182,212,0.4)] transition-transform duration-500 hover:scale-[1.02]"
                            />
                        </div>
                    </div>
                </div>
